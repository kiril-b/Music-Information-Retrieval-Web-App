    ...
    return (
        <div className="modal-similar">
            <div className="modal-similar-content">
                ...
                <form onSubmit={handleSearch} className="flex mb-4 w-full gap-3">
                    ...
                    <button  data-testid='search' type="submit" className="bg-pink-600 hover:bg-pink-700 text-white px-1 py-2 rounded-md w-20 flex justify-center"
                    >
